...
namespace PDT.Plugins.Zoom.Room
{
    ...
    public interface IHasZoomRoomLayouts : IHasCodecLayouts
    {
        ...
        zConfiguration.eLayoutStyle LastSelectedLayout { get; }
        zConfiguration.eLayoutStyle AvailableLayouts { get; }
    ...
    public class LayoutInfoChangedEventArgs : EventArgs
    {
        ...
        public zConfiguration.eLayoutStyle CurrentSelectedLayout { get; set; }
