...
Public methods declared in this source file include: `Factory_Source_Sets_MinimumEssentialsFrameworkVersion_To_3`, `Factory_Source_Assigns_TypeNames`, `Factory_Source_Contains_TypeName`, `No_Duplicate_TypeNames_Across_Factories`. Use repository search to identify callers, implementers, serializers, tests, and configuration references before changing a public name or shape.
